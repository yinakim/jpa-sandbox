...
COMMENT ON COLUMN PRODUCT.PRODUCT_CD IS '상품고유번호(EX. P00001)';
...
COMMENT ON TABLE PRODUCT_CD_SEQ IS '상품고유번호(EX. P00001) 생성용  SEQ 자체관리 테이블';
...
(
    ...
    CONSTRAINT FK_OPTIONGROUP_PRODUCT FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT (PRODUCT_ID)
);
