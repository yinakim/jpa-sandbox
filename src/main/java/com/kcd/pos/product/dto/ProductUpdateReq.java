...
public class ProductUpdateReq extends BaseDto {
    ...
    @Builder
    public ProductUpdateReq(String productNm, int price, String storeId, Long categoryId, BgColor bgColor, String taxYn) {
